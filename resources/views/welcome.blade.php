...
<body class="nk-body bg-lighter ">
                                        ...
                                        <div class="card card-bordered card-full">
                                            <div class="card-inner">
                                                ...
                                                <div class="card-amount">
                                                    <span class="amount"> 49,595.34 <span
                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-bordered  card-full">
                                            <div class="card-inner">
                                                ...
                                                <div class="card-amount">
                                                    <span class="amount"> 79,358.50 <span
                                                            class="currency currency-usd">USD</span>
                                                    </span>
                                                </div>
                                                <div class="invest-data">
                                            ...
                                            <div class="card-inner">
                                                <div class="card-title-group mb-1">
                                                    <div class="card-title">
                                                        ...
                                                        <p>The investment overview of your platform. <a
                                                                href="#">All Investment</a></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="align-center">
                                                            ...
                                                            <span class="tb-sub ml-2">Dimond <span
                                                                    class="d-none d-md-inline">- Daily 8.52% for 14
                                                                    Days</span></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <span class="tb-sub tb-amount">1.094780
                                                            <span>BTC</span></span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                ...
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="align-center">
                                                            ...
                                                            <span class="tb-sub ml-2">Platinam <span
                                                                    class="d-none d-md-inline">- Daily 14.82% for 7
                                                                    Days</span></span>
                                                        </div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                ...
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="align-center">
                                                            ...
                                                            <span class="tb-sub ml-2">Silver <span
                                                                    class="d-none d-md-inline">- Daily 4.76% for 21
                                                                    Days</span></span>
                                                        </div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                    ...
                    <div class="nk-footer-wrap">
                        ...
                        <div class="nk-footer-links">
                            <ul class="nav nav-sm">
                                ...
                                <li class="nav-item">
                                    <a href="#" data-toggle="modal" data-target="#region" class="nav-link"><em
                                            class="icon ni ni-globe"></em><span class="ml-1">Select
                                            Region</span></a>
                                </li>
                            </ul>
                        </div>
    ...
    <script src="./assets/js/charts/gd-invest.js?ver=2.9.1"></script>
</body>
